# The following code was borrowed from https://github.com/ActiveVisionLab/nope-nerf/tree/main/utils_poses

import numpy as np
import torch

from utils.ATE.align_utils import alignTrajectory
from utils.nope_nerf_utils_poses.lie_group_helper import SO3_to_quat, convert3x4_4x4
...
def align_ate_c2b_use_a2b(traj_a, traj_b, traj_c=None):
    ...
    print("we get global alignment s, R, t")
    print(s)
    print(R)
    print(t)
